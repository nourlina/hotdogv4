...
iScroll8.prototype = {
	...
	touchStart: function(e) {
        ...
        if(target.tagName != 'SELECT' && target.tagName != 'TEXTAREA'  && target.tagName != 'INPUT' && target.tagName != 'RADIO') {
            e.preventDefault();
        }
		e.stopPropagation();
		
		
		that.scrolling = true;		// This is probably not needed, but may be useful if iScroll8 is used in conjuction with other frameworks
...
// Expose iScroll8 to the world
window.iScroll8 = iScroll8;
})();