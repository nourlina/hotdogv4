...
iScroll5.prototype = {
	...
	touchStart: function(e) {
		...
		that.scrolling = true;		// This is probably not needed, but may be useful if iScroll5 is used in conjuction with other frameworks
