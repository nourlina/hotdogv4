...
JBackbone.prototype.init = function(config){		
	...
	if(!config.BOX_ID) config.BOX_ID = "sliderr";
...
JBackbone.prototype.showMenu = function(menuPage, config){
	...
	var width = window.innerWidth-this.config.MENU_MARGIN;width=300;
	//alert(width);
...
JBackbone.prototype.hideMenu = function(){
	...
	var width = window.innerWidth-this.config.MENU_MARGIN; //alert(width);
	width=300;
